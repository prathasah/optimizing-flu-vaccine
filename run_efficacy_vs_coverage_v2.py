...
############################################
#write csv
writer1 = csv.writer(open('Incidence_8Dec2017_v2.csv','wb'))
...
############################################################
writer2 = csv.writer(open('Hospitalizations_8Dec2017_v2.csv','wb'))
...
##################################################
writer3 = csv.writer(open('vaccinated_comparisons_8Dec2017_v2.csv','wb'))
...
for vacEfficacy in np.arange(0.31, 0.61, 0.01):
